...
export default function NetworkLegend() {
  return (
    <aside className="panel p-4 text-xs space-y-5 lg:sticky lg:top-20">
      <div>
        <h3 className="font-mono uppercase tracking-wider text-accent-vol2 mb-2">Categories</h3>
      ...
      <div>
        <h3 className="font-mono uppercase tracking-wider text-accent-vol2 mb-2">Connections</h3>
        <ul className="space-y-1.5">
      ...
      <div>
        <h3 className="font-mono uppercase tracking-wider text-accent-vol2 mb-2">Stakeholder flags</h3>
        <ul className="space-y-1.5">
