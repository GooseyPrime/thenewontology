  ...
  const stylesheet = useMemo(
    () => [
      ...
      })),
      {
        ...
        style: {
          "line-color": "rgba(205, 133, 63, 0.35)",
          "line-style": "dotted",
          width: 1,
        },
      },
  ...
  return (
    <div className={fullscreen ? "fixed inset-0 z-50 bg-bg p-4 flex flex-col" : ""}>
      <p className="text-xs text-muted mb-4 font-serif">
        Click an organization to focus its cluster; scroll or use +/− to zoom. Hover a person for
        details; click to pin.
      </p>
