...
const terms = [
  ...
  {
    term: "Higher Order Non-Human Intelligence (HO-NHI)",
    definition:
      "Institutional language for non-human intelligence understood as directing or coordinating phenomena rather than merely embodied in craft. Entered public discourse via Rear Adm. Tim Gallaudet (Ret.) in May 2026 and aligns with the site's bifurcation between biological non-humans, artificial systems, and consciousness-mediated contact — distinct from the extraterrestrial hypothesis.",
  },
  {
  ...
  },
  {
    term: "VASCO",
    definition:
      "Vanishing & Appearing Sources during a Century of Observations — research program analyzing transient events on historical Palomar photographic plates. Villarroel et al. (PASP 2025) and follow-on preprints (e.g. Cann 2026) constrain magnetospherically coupled sources and pre-Sputnik anomaly catalogs.",
  },
  {
    term: "TOP SECRET UMBRA",
    definition:
