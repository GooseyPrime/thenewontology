  ...
  return (
    <>
      ...
      <main className="relative min-h-screen px-6 py-16 max-w-prose mx-auto" style={{ zIndex: 1 }}>
        ...
        <h1 className="font-sans text-4xl md:text-5xl font-semibold text-text mb-8">How to Think When Nobody Has the Answers</h1>
        ...
        <div className="mt-16 pt-8 border-t border-border flex justify-between items-center">
          <Link href="/the-bigger-world/chapter-4" className="inline-flex items-center gap-2 font-sans text-accent hover:underline underline-offset-4"><span>←</span> Chapter 4</Link>
          <Link href="/the-bigger-world/chapter-6" className="inline-flex items-center gap-2 font-sans text-accent hover:underline underline-offset-4">Chapter 6 <span>→</span></Link>
        </div>
      </main>
    </>
  );
