    ...
    <>
      ...
      <main className="relative min-h-screen px-6 py-16 max-w-prose mx-auto" style={{ zIndex: 1 }}>
        ...
        <div className="prose prose-invert">
          ...
          <p>
            In April 2025, the COGITATE Consortium published landmark results in <em>Nature</em> — the outcome of a $20 million Templeton Foundation-funded adversarial collaboration that represented the largest and most methodologically rigorous consciousness study ever conducted. The collaboration assembled over 40 authors including David Chalmers, Christof Koch, Stanislas Dehaene, and Giulio Tononi, spanning laboratories across three continents and 256 participants. Its design was explicitly adversarial: proponents of Integrated Information Theory (IIT) and Global Workspace Theory (GWT) agreed in advance to a pre-registered protocol that would test each theory&apos;s predictions against shared empirical data.
          </p>
          <p>
            The result: IIT fared &quot;slightly better&quot; than GWT, though neither was definitively confirmed. More consequentially, Christof Koch formally conceded the bet he had made with David Chalmers in 1998 — that the neural correlates of consciousness would be identified within 25 years — acknowledging that a quarter-century of intensive neuroscientific investigation had failed to resolve the fundamental question.
          </p>
          <p>
            The significance of the COGITATE result lies not in the narrow margin between theories but in what the comparison implies: the findings were more consistent with consciousness-as-fundamental models (in which information integration is primary) than with purely computational or emergent models (in which consciousness is a byproduct of global information broadcast). This is precisely the theoretical terrain on which Orch-OR, Strømme&apos;s universal field, and Hoffman&apos;s conscious realism operate.
          </p>
          <p className="text-sm text-muted italic">
